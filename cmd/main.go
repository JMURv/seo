...
import (
	"context"
	"fmt"
	"github.com/JMURv/par-pro-seo/internal/cache/redis"
	ctrl "github.com/JMURv/par-pro-seo/internal/controller"
	"github.com/JMURv/par-pro-seo/internal/discovery"

	//handler "github.com/JMURv/par-pro-seo/internal/handler/http"
	handler "github.com/JMURv/par-pro-seo/internal/handler/grpc"
	tracing "github.com/JMURv/par-pro-seo/internal/metrics/jaeger"
	metrics "github.com/JMURv/par-pro-seo/internal/metrics/prometheus"
	"go.uber.org/zap"
	//mem "github.com/JMURv/par-pro/internal/repository/memory"
	db "github.com/JMURv/par-pro-seo/internal/repository/db"
